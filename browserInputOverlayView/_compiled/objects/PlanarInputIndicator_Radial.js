...
function PlanarInputIndicator_Radial(x, y, width, height, properties) {
...
PlanarInputIndicator_Radial.prototype.update = function (delta) {
    let xAxis = 0;
    let yAxis = 0;
...
PlanarInputIndicator_Radial.prototype.draw = function (canvas, ctx) {
