class PropertyEdit {
    constructor() {
        ...
        this.targetObjectIndex = null; // Track object by array index
        this.configManager = null; // ConfigManager reference
        this.targetScene = null;
        this.applySceneConfig = null;
        this.deleteCallback = null;
        this.pendingChanges = new Map(); // Accumulate changes until Done
    }
    hidePropertyEdit() {
    ...
    showPropertyEdit(config, targetObject, objArrayIdx, configManager, deleteCallback) {
        ...
        if (!containerForPossibleEditorWindows || !propertyTable || !editorTitle || !leftPanel)
            return;
        ...
        const innerConfig = config[configType];
    ...
    showCanvasConfig(config, canvas, applyCallback) {
        ...
        const editorTitle = document.getElementById("editorTitle");
        const leftPanel = document.getElementById("leftPanel");
        if (!containerForPossibleEditorWindows || !propertyTable || !sceneConfigText || !editorTitle || !leftPanel)
            return;
...
export { PropertyEdit };
//# sourceMappingURL=PropertyEdit.js.map