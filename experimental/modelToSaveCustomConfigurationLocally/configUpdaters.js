export function updateObjectPosition(config, objectIndex, x, y) {
    ...
    newObjects[objectIndex] = { [typeKey]: updatedInnerConfig };
...
export function updateObjectByIndex(config, objectIndex, updates) {
...
//# sourceMappingURL=configUpdaters.js.map